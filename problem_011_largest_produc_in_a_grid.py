...
have been marked in red(between *).
...
def solution(k: int) -> int:
    ...
    return max(max(left_top_diagonal(i, j),
                   right_top_diagonal(i, j),
                   horizontal(i, j),
                   vertical(i, j))
...
if __name__ == '__main__':
    print(solution(4))   # 70600674
    print(solution(10))  # 2583621418281932160
    print(solution(20))  # 182479798369776159130095937843200000
